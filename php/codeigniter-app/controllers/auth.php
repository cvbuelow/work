...
class Auth extends MY_Controller {
    ...
    function __construct() 
    {
		...
		if($this->flexi_auth->is_logged_in() && uri_string() != 'auth/logout') 
		{
			...
			redirect(empty($redirect) ? 'program/apply' : $redirect);
		}
    ...
    function login_via_ajax()
    {
		...
		{
			$this->load->view('auth/login_via_ajax_view', $this->data);
		}
    }
	...
	function register_account()
	{
		...
		$this->_content('auth/public/register');
		$this->_render();
	}
	...
	function resend_activation_token()
	{
		...
		$this->data['page_title'] = 'Resend Activation Token';
		$this->_content('auth/public/resend_activation_token_view');
		$this->_render();
	}
	...
	function forgotten_password()
	{
		...
		$this->data['page_title'] = 'Forgotten Password';
		$this->_content('auth/public/forgot_password_view');
		$this->_render();
	}
	...
	function manual_reset_forgotten_password($user_id = FALSE, $token = FALSE)
	{
		...
		$this->load->view('auth/public/forgot_password_update_view', $this->data);
	}
